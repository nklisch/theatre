/// CLI Journey Tests — real Godot headless + stage binary subprocess.
///
/// These tests require:
...
///
/// Run: cargo test -p stage-server --test cli_journeys -- --nocapture
mod support;

use serde_json::json;
use support::cli_fixture::StageCliFixture;
...
async fn cli_journey_explore_scene() {
    let fixture = StageCliFixture::start_3d()
        .await
...
async fn cli_journey_2d_scene() {
    let fixture = StageCliFixture::start_2d()
        .await
