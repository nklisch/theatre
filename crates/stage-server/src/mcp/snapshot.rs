...
use stage_protocol::query::{DetailLevel, EntityData, PerspectiveParam, SnapshotResponse};
use stage_protocol::static_classes::{classify_static_category, is_static_class};
...
pub fn build_perspective(data: &stage_protocol::query::PerspectiveData) -> Perspective {
...
fn perspective_json(
    raw: &stage_protocol::query::PerspectiveData,
    persp: &Perspective,
) -> serde_json::Value {
    serde_json::json!({
